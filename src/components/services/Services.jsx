      ...
      <div className="services__container container grid">
        ...
        <div className="services__content">
          ...
          <div className= {toggleState === 1 ? "services__modal active-modal" : "services__modal"}>
            <div className="services__modal-content">
                ...
                <h3 className="services__modal-title">Web Desginer</h3>
                <p className="services__modal-description">Service with More
                than 3 years of expericence. Providing quality works to 
                clinadts and companies</p>
                ...
                <ul className="services__modal-services grid">
                    ...
                    <li className="services__modal-service">
                        ...
                        <p className="services__modal-info">I develop te user interface.</p>
                    </li>
                    ...
                    <li className="services__modal-service">
                        ...
                        <p className="services__modal-info">I create great UX</p>
                    </li>
                    ...
                    <li className="services__modal-service">
                        ...
                        <p className="services__modal-info">Design and mockups of products
                        for companies.</p>
                    </li>
                    ...
                    <li className="services__modal-service">
                        ...
                        <p className="services__modal-info">I create gread brand Image</p>
                    </li>
        ...
        <div className="services__content">
            <div>
              ...
              <h3 className="services__title">UI Designer</h3>  
            </div>
